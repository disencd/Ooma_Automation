...
try:
    ...
    #lib.create_transport(pj.TransportType.TLS, pj.TransportConfig(5061))
    lib.start()
    acc = lib.create_account(pj.AccountConfig("nagpn.smb.cert1.ooma.com", "fj4cdew1yi", "cssljvix46"))
