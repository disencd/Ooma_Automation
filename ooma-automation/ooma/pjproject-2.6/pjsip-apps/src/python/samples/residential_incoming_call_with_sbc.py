...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    acc = lib.create_account(pj.AccountConfig("sbc1-cert1-ext.cn.ooma.com", "14693019886", "password1"))
    #acc = lib.create_account(pj.AccountConfig("sbc1-cert1-ext.cn.ooma.com", "14693019874", "password1"))
    ...
    acc1 = lib.create_account(pj.AccountConfig("sbc1-cert1-ext.cn.ooma.com", "19712732987", "password1"))
...
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    while True:
        ...
        print "Menu:  m=make call, h=hangup call, a=answer call, q=quit, ho=hold call, d=dtmf"
	    ...
	    print "\nEnter the DTMF to Dial: "
	    input = sys.stdin.readline().rstrip("\r\n")
            if input == "":
                continue
            lck = lib.auto_lock()
	    current_call.dial_dtmf(input)   		
            del lck
